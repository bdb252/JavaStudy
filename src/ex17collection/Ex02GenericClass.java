...
자료형에 해당하는 부분은 타입 매개변수로 교체하고 인스턴스 생성 시 자료형을 결정하기 위해 클래스명<T> 형태로 변경한다.
*/
...
public class Ex02GenericClass {
	...
	public static void main(String[] args) {
		...
		각각 Apple, Banana 인스턴스를 저장할 수 있는 Box인스턴스가 생성되었다.
		 */
		...
		/*
		OrangeBox는 인스턴스 생성 시 Orange를 저장할 수 있는 용도로 생성되었으므로 다른 인스턴스는 저장할 수 없다.
