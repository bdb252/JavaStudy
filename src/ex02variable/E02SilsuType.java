...
public class E02SilsuType {
	/*
	 실수 자료형
	 -정수형보다는 실수형이 더 큰 자료형이다. 0과 1 사이에 무수히 많은 실수가 존재하기 때문이다.
	...
	public static void main(String[] args) {
		...
		//float 보다는 double이 더 크므로 연산결과는 double이 된다.
		double d1 = 3.14;
		double d2 = f6 + d1;
