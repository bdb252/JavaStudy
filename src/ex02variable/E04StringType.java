...
public class E04StringType {
	...
	public static void main(String[] args) {
		...
		/*
		String 클래스 : 참조형 변수로써 기본 자료형이 아닌 클래스로 문자열을 저장하고, 조작하는 기능을 가진다.
					Java에서는 문자열을 표현할  때 "으로 감싸주면 되고, 연결 시에는 +기호를 사용한다.
		 */
		int number;
		number = 99;
		
		/*
		클래스를 통해 생성한 참조형 변수와 기본 자료형 변수 사이에서는 형 변환이 불가능하다.
...
//		String stringNumber2 = (String)100;
		...
		//String 변수는 주로 double quotation을 통해 생성함.
