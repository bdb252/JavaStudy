...
public class E02StringMethod1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("str2의 길이:"+str2.charAt(1));
		
		/*
		3] compareTo() : 2개의 문자열의 첫번째 문자부터 순차적으로 비교하면서 앞문자의 아스키코드가 크면 양수를 반환하고, 
		뒷문자의 아스키코드가 크면 음수를 반환한다. 두 문자열이 같으면 0을 반환한다.
		 */
		System.out.println("### 3 ###");
		//double quotation으로 감쌌으므로 문자열로 선언
		String str3 = "A";
		String str4 = "B";
		...
		/*
		4] concat() : 두개의 문자열을 연결할 때 사용. print문에서 +와 동일한 역할이다.
		 */
