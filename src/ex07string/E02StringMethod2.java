...
public class E02StringMethod2 {
	...
	public static void main(String[] args) {
		...
		/*
		6] codePointAt(인덱스) : 문자열의 특정 인덱스의 문자를 찾은 후 아스키코드(혹은 유니코드)를 반환한다.
		 */
		...
		printf()와 사용법이 동일하고, 주로 웹애플리케이션을 제작할 때 사용한다. 
		*/
		...
		/*
		10] indexOf() : 문자열에서 특정 문자열의 시작 인덱스를 반환한다. 만약 존재하지 않으면 -1을 반환한다.
		...
		System.out.println((email1.indexOf("@")==-1 && email1.indexOf(".")==-1) ? "이메일형식아님" : "이메일형식맞음");
	}
