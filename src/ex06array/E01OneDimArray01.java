...
/*
배열 : 순차적으로 메모리의 공간이 할당되는 형태로써 하나가 아니라 여러개의 변수가 필요한 경우 사용된다.
-자바에서는 배열을 인스턴스 형태로 생성하므로 new를 사용한다.
-생성된 배열은 힘(Heap)영역에 저장되고, 할당된 메모리의 주소값을 반환한다.
...
public class E01OneDimArray01 {
	...
	public static void main(String[] args) {
		...
		/*
		배열의 선언과 동시에 초기화하는 경우 자바 컴파일러는 초기값의 개수를 통해 배열의 크기를 결정할 수 있다.
		따라서 이런 경우에는 크기를 생략하도록 약속되어있다. */
