...
public class E01MethodBasic {
	...
	/*
	메서드2 : 반환값X, 매개변수X
	=> 전달받는 값 없이 이름을 입력받은 후 namePrint() 메서드를 호출한다. 이와 같이 반환값이 없는 경우에는 반드시 void를 명시해야 한다.
	 */
	...
	/*
	메서드3 : 반환값X, 매개변수O
	=> 문자열을 인수로 전달받아 단순히 출력한다. 반환값이 없는 경우 실행이 종료되면 호출했던 지점으로 실행의 흐름이 이동된다.
	 */
	...
	public static void main(String[] args) {
		...
		/*
		메서드를 호출할 때는 메서드의 원형을 그대로 기술한다.
		매개변수가 있다면 그 개수만큼 포함해야 한다. 이때 매개변수의 개수가 다르거나 타입이 다르면 에러가 발생한다.
		 */
