...
/*
인터페이스(interface)
- 클래스가 객체의 설계도라면 인터페이스는 클래스의 설계도라고 할 수 있다.
- 자바는 단일 상속을 원칙으로 하지만 인터페이스를 통해 다중 상속을 구현할 수 있다.
- 추상클래스와 동일하게 상속을 목적으로 제작되므로 구현받은 하위클래스에서는 반드시 추상메서드를 오버라이딩 해야 한다.
...
//	public MyInterface1() {}
	...
	/*
	멤버메서드 : 메서드는 선언 시 추상메서드가 된다. 따라서 public abstract는 생략하는 것이 좋다.
	 */
...
/*
인터페이스는 콤마를 이용해서 여러 개를 '구현'할 수 있다.
...
public class E03InterfaceMain {
	...
	public static void main(String[] args) {
		...
		/*
		'구현'한 인터페이스를 통해 참조변수를 선언할 수 있다. MyClass1의 부모는 모두 3개이다.
		 */
		...
		//MyClass의 부모는 모두 3개이므로 아래는 모두 참조가능하다.
