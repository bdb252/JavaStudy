...
class Seoul extends Korea{
	...
	/*
	4개의 접근지정자를 통해 정의한 메서드를 호출. 단 부모클래스가 다른 패키지에서 선언되었으므로 default, private멤버는 호출할 수 없다.
	 */
	public void callMethod() {
		super.publicMethod("callMethod->");
		super.protectedMethod("callMethod->");
//		super.defaultMethod("callMethod->"); //에러발생
//		super.privateMethod("callMethod->"); //에러발생
		/*
		이와같이 직접 접근할 수 없는 메서드는 접근 가능한 메서드를 통해 간접 호출해야 한다.
		 */
	}
}
