...
public class E01If03 {
	...
	public static void main(String[] args) {
		...
		/*
		시나리오] 국영수 점수의 평균값을 구하여 학점을 출력하는 프로그램을 작성하시오.
		90점이상은 A학점 ... 60점 미만은 F학점을 출력하면 된다.
		 */
		//점수는 정수타입으로 변수 및 초기값 할당
		int kor = 99, eng = 70, math = 64;
		/*
		평균값은 소수점이 될 수 있으므오 실수형으로 선언하는 것이 좋다.
		double형의 결과를 얻기 위해 3.0으로 나눈다. */
		double avg = (kor + eng + math) / 3.0;
		System.out.println("평균점수는(그대로): " + avg);
		//서식문자를 이용해서 소수 이하 2자리까지만 출력
		...
		/*
		높은 점수라 할지라도 60점 이상의 조건에 만족하므로 무조건 D학점이 출력된다.
		따라서 논리적으로 문제가 있는 코드이다.
		이와 같이 구간이 필요한 경우에는 큰 숫자를 먼저 기술해야 한다.
		 */
		if(avg >= 60) {
			System.out.println("D학점");
		}
