...
/*
 ...
 형식]
 	...
 	-만약 break문이 없으면 그 아래의 모근 문장이 실행된다.
 	-default문은 앞에서 모든 case와 일치되지 않을 때 실행되는 부분으로 if문의 else와 동일한 역할을 한다.
 */
...
//		}
		...
		//정수타입으로 점수를 할당
		int kor = 95, eng = 90, math = 95;
		/*Java에서는 switch문에 조건식을 사용할 수 없으므로
		평균점수의 구간을 아래와 같이 10으로 나눈 몫을 통해 구해야 한다.*/
