...
/*
static 블록
: 동일 클래스 내 main() 메서드보다 먼저 실행되는 블록으로 main()메서드의 실행코드가 없어도 먼저 실행된다.
...
public class E02StaticBlockMain {
	...
	//static 블록 정의
	static {
		//블록내에서 정적변수에 접근할 수 있다.
		staticVar = 1000;		
		
		/*
		블록 내에서만 사용할 수 있는 변수로써, 블록 내에서는 일반변수를 생성할 수 있다.
		 */
		int localVar;
		localVar = 1000;
...
//		instanceMethod(); //에러
	...
	/*
	생성자메서드 정의: 생성자에서는 정적멤버에 접근이 가능하다. 일반적인 멤버변수와 동일하다.
	 */
	...
	public static void main(String[] args) {
		...
		/*
		static 블록 내에서 선언된 변수는 지역변수이므로 main메서드에서는 사용할 수 없다.
		static 블록 지역 내에서만 사용할 수 있다.
		 */
