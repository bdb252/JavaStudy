...
public class E01WrapperClass2 {
	...
	public static void main(String[] args) {
		...
		/*
		문자열을 숫자로 변경시 반드시 숫자형식만 기술해야한다. '원'은 숫자가 아니므로 변경시 예외가 발생한다.
		 */
		String money = "120원";
//		System.out.println("120원:"+Integer.parseInt(money)); //예외발생
		
		/*
		실수형태의 문자열을 숫자로 변경할 때는 parseInt()는 사용할 수 없다. 앞과 동일한 예외가 발생한다.
		 */
...
//		System.out.println(Integer.parseInt(floatString));
		...
		/*
		isDigit() : 인자로 전달된 문자가 숫자인지 판단한다. 숫자일 때 true를 반환한다.
		 */
		...
		isUpperCase() : 대문자인지 판단. 단 영문이 아닐 경우 false를 반환한다.
		 */
